 ...
 */
public class MainScreenAdapter extends
        CursorAdapter {


    public MainScreenAdapter(Context context, Cursor c, int flags) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        Picasso.with(context).load(Utility.getImageURL(posterPath)).error(R.drawable.no_poster_found).into(viewHolder.imageView);
    }
