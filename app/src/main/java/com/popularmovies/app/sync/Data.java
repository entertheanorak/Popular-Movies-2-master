 ...
 */
public class Data {
    public final String LOG_TAG = Data.class.getSimpleName();
        ...
        try{
            ...
            for(int i = 0; i < moviesArray.length(); i++) {
                ...
                if (!Utility.isMovieIdFavorite(favoriteMovieIds, movieId))
                {
                    ...
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_MOVIE_ID, movieId);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_IS_ADULT, isAdult);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_BACK_DROP_PATH, backdropPath);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_ORIGINAL_LANGUAGE, originalLanguage);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_ORIGINAL_TITLE, originalTitle);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_OVERVIEW, overview);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_RELEASE_DATE, releaseDate);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_POSTER_PATH, posterPath);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_POPULARITY, popularity);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_TITLE, title);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_IS_VIDEO, isVideo);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_VOTE_AVERAGE, voteAverage);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_VOTE_COUNT, voteCount);
                    movieValues.put(ContractKiller.MovieEntry.COLUMN_DATE, mDayTime.setJulianDay(mJulianStartDay));
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = mContext.getContentResolver().bulkInsert(ContractKiller.MovieEntry.CONTENT_URI, cvArray);
            }
        ...
        private int getTrailersDataFromJson(String moviesJsonStr)
            ...
            try {
                ...
                for (int i = 0; i < moviesArray.length(); i++) {
                    ...
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_MOVIE_ID, movieId);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_TRAILER_ID, trailerId);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_ISO_369_1, ISO_639_1);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_KEY, key);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_NAME, name);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_SITE, site);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_SIZE, size);
                    trailerValues.put(ContractKiller.MovieTrailerEntry.COLUMN_TYPE, type);
                    trailerValues.put(ContractKiller.MovieEntry.COLUMN_DATE, mDayTime.setJulianDay(mJulianStartDay));
                ...
                if (cVVector.size() > 0) {
                    ContentValues[] cvArray = new ContentValues[cVVector.size()];
                    cVVector.toArray(cvArray);
                    inserted = mContext.getContentResolver().bulkInsert(ContractKiller.MovieTrailerEntry.CONTENT_URI, cvArray);
                }
                setMovieStatus(mContext, MOVIE_STATUS_OK);
            } catch (JSONException e) {
                Log.e(LOG_TAG, e.getMessage(), e);
...
//            http://api.themoviedb.org/3/movie/135397/reviews?api_key=28edec251247e1d7328ab3ec7f483cd0
        ...
        private int getReviewsDataFromJson(String moviesJsonStr)
            ...
            try {
                ...
                for (int i = 0; i < moviesArray.length(); i++) {
                    ...
                    reviewValues.put(ContractKiller.MovieReviewEntry.COLUMN_MOVIE_ID, movieId);
                    reviewValues.put(ContractKiller.MovieReviewEntry.COLUMN_REVIEW_ID, reviewId);
                    reviewValues.put(ContractKiller.MovieReviewEntry.COLUMN_AUTHOR, author);
                    reviewValues.put(ContractKiller.MovieReviewEntry.COLUMN_CONTENT, content);
                    reviewValues.put(ContractKiller.MovieReviewEntry.COLUMN_URL, url);
                    reviewValues.put(ContractKiller.MovieReviewEntry.COLUMN_DATE, mDayTime.setJulianDay(mJulianStartDay));
                ...
                if (cVVector.size() > 0) {
                    ContentValues[] cvArray = new ContentValues[cVVector.size()];
                    cVVector.toArray(cvArray);
                    inserted = mContext.getContentResolver().bulkInsert(ContractKiller.MovieReviewEntry.CONTENT_URI, cvArray);
                }
                setMovieStatus(mContext, MOVIE_STATUS_OK);
            } catch (JSONException e) {
                Log.e(LOG_TAG, e.getMessage(), e);
    ...
    private void deleteOldData() {
        ...
        if (favoriteMovieIds != null && favoriteMovieIds.length > 0) {
            ...
            criteriaString = ContractKiller.MovieEntry.COLUMN_MOVIE_ID + " NOT IN (" + favoriteMovieIdsString + ")";
        }

        // delete old data so we don't build up an endless history
        int deleted = mContext.getContentResolver().delete(ContractKiller.MovieReviewEntry.CONTENT_URI,
                criteriaString,
                null);
        ...
        // delete old data so we don't build up an endless history
        deleted = mContext.getContentResolver().delete(ContractKiller.MovieTrailerEntry.CONTENT_URI,
                criteriaString,
                null);
        ...
        // delete old data so we don't build up an endless history
        deleted = mContext.getContentResolver().delete(ContractKiller.MovieEntry.CONTENT_URI,
                criteriaString,
                null);
