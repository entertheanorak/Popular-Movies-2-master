...
public class HelpDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_TRAILER_TABLE = "CREATE TABLE " +
                ...
                MovieTrailerEntry.COLUMN_DATE + " INTEGER NOT NULL, " + " FOREIGN KEY (" +
                MovieTrailerEntry.COLUMN_MOVIE_ID + ") REFERENCES " +
                MovieEntry.TABLE_NAME + " (" +
                MovieEntry.COLUMN_MOVIE_ID + ") " + " UNIQUE (" +
        ...
        final String SQL_CREATE_REVIEW_TABLE = "CREATE TABLE " +
                ...
                MovieReviewEntry.COLUMN_DATE + " INTEGER NOT NULL, " + " FOREIGN KEY (" +
                MovieReviewEntry.COLUMN_MOVIE_ID + ") REFERENCES " +
                MovieEntry.TABLE_NAME + " (" +
                MovieEntry.COLUMN_MOVIE_ID + ") " + " UNIQUE (" +
